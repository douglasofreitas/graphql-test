...
export interface CommentInstante extends Sequelize.Instance<CommentAttibutes> {}

export interface CommentModel extends BaseModelInterface, Sequelize.Model<CommentInstante, CommentAttibutes> {}
